...
*/
  ...
  function renderServices() {
    ...
    html += '<div class="svc-count-strip" style="margin:0 16px 8px;">' +
    ...
    html += '<p style="font-size:12px; color:var(--text-muted); margin:0 18px 4px; text-align:' + (isEn ? 'left' : 'right') + ';">' + hintText + '</p>';

    // گرید کادرهای مربعی مدرن (۶ بخش اصلی)
      ...
      html += '' +
        '<div class="svc-square-card" style="--accent-rgb:' + group.accent + '; --accent-color:' + group.accentColor + ';" onclick="openServiceCategory(\'' + group.id + '\')">' +
          '<div class="svc-square-top">' +
            '<div class="svc-square-icon">' + group.icon + '</div>' +
    ...
    let html = '' +
      '<div class="svc-cat-hero" style="--accent:' + group.accent + ';">' +
        ...
        '<div class="svc-cat-hero-top">' +
          '<div class="svc-cat-icon" style="background:rgba(' + group.accent + ',0.2); border-color:rgba(' + group.accent + ',0.35); font-size:32px; width:56px; height:56px;">' + group.icon + '</div>' +
  ...
  function serviceCardHtml(id) {
    ...
    return '' +
      '<div class="svc-card" style="--accent:' + s.accent + ';" onclick="openServiceDetail(\'' + s.id + '\')">' +
        ...
        '<div class="svc-icon-tile" style="background:rgba(' + s.accent + ',0.15); border-color:rgba(' + s.accent + ',0.25);">' + s.icon + '</div>' +
    ...
    html += '' +
      '<div class="svc-detail-hero" style="--accent:' + s.accent + ';">' +
        ...
        '<div class="svc-detail-hero-top">' +
          '<div class="svc-icon-tile lg" style="background:rgba(' + s.accent + ',0.2); border-color:rgba(' + s.accent + ',0.35);">' + s.icon + '</div>' +
